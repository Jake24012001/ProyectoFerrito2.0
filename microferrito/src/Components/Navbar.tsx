    ...
    return (
        ...
        >
            <div className="container-fluid">
                ...
                <Link className="navbar-brand d-flex align-items-center" to="/" style={{ color: whiteText, fontWeight: 'bold' }}>
                ...
                <div className="collapse navbar-collapse" id="navbarContent">
                    ...
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        {/* Carrito */}
                        <li className="nav-item">
                            <Link className="nav-link" to="/carrito" style={{ color: whiteText }}>
                        ...
                        <li className="nav-item">
                            <Link className="nav-link" to="/factura" style={{ color: whiteText }}>
                        ...
                        <li className="nav-item">
                            <Link className="nav-link" to="/auditoria" style={{ color: whiteText }}>
